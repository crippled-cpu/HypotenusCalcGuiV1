//outside of class is where you import shit
...
public class Calculator extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent event) {
		...
		try {
			...
			//Now If you want to do the same thing but in console un comment the following below
...
//			  
//			 	System.out.println("Enter Size x: "); x = scanner.nextDouble();
//			 	System.out.println("Enter Size y: "); y = scanner.nextDouble();
//			  
//			 	//need to incorporate formula //formula = (x*x)+(y*y)
//			 
//			 	z = Math.sqrt((x*x)+(y*y));
//			  
